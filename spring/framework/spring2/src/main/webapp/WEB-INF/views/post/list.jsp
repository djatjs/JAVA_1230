...
<body>
	...
	<c:forEach items="${boardList}" var="item">
		<button class="btn btn-outline-success btn-board" data-num="${item.bo_num}">${item.bo_name}</button>
	</c:forEach>
	...
	<!-- 정렬 방식 선택 -->
	<select class="sel-type form-control col-3 mt-3">
