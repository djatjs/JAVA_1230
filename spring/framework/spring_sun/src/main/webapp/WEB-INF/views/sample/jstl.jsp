...
<body>
	...
	<!-- {}안에서는 공백이 몇개 들어가도 상관없지만, "사이와 $사이에 공백이 들어가면 정상적으로 동작하지 않음  -->
	<c:if test="${age < 20}">
		<h3>성인이 아닙니다.</h3>
	</c:if>
	<c:choose>
	...
	<!-- 서버 로컬 정보가 한국으로 되어있어서 아래 setLocale이 반영되지 않음  -->
	...
	<fmt:formatDate value="${date}" pattern ="yyyy-MM-dd EE요일"/> <br>
	${date}
</body>
</html>
