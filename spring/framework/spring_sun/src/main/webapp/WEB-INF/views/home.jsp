...
<!--
서버에서 보낸 데이터를 처리할 때에는 $`{화면에서사용할이름}을 이용하여 활용
- 단 주석에서도 바로 인식되기 때문에 주석에서 조심히 작성  
-->
...
<a href="/spring/홍길동/22">url 경로에 데이터 보내기</a>
<h1>redirect 예제</h1>
