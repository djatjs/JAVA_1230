...
public class UploadFileUtils {
    ...
    public static String uploadFile(String uploadPath, String originalName, byte[]
        ...
        //날짜를 이용하여 폴더를 생성해서 관리 => 2025-03-26 => 2025폴더 > 03폴더 > 26폴더 생성하여 경로를 리턴
    ...
    private static String calcPath(String uploadPath) {
        //현재 시간을 캘린더 객체로 가져옴(캘린더 객체가 년,월,일 추출하기 편함)
    	Calendar cal = Calendar.getInstance();
    	
    	//년을 추출해서 앞에 구분자 추가	\\2025
    	//File.separator : 폴더와 폴더 사이를 구분하는 문자열(운영체제에 맞는 구분자를 설정?)
    ...
    /**
     * uploadPath안에 paths 폴더들이 있으면 생성하는 메소드
    ...
    private static String getFileName(String path, String fileName)
    	...
    	// /2025/03/26/uuid_a.jpg >> db에는 이 경로를 저장?
