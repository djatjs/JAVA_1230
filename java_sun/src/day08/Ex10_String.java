...
public class Ex10_String {
	...
	public static void main(String[] args) {
		...
		//subString(index, endIndex) : index번지부터 endIndex-1까지의 문자열
