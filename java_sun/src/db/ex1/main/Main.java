...
public class Main {
	...
	public static void main(String[] args) {
		...
		/* 2학년 1반 1번 학생의 등록된 성적들을 가져오는 코드 */
		// 2학년 1반 1번 학생의 정보를 가져옴
		StudentVO std3 = studentService.getStudent(2,1,1);
		...
		StudentVO std5 = new StudentVO(0, 1, 1, 11, "111");
		if(studentService.updateStudentName(std5)) {
			System.out.println(std5+"학생의 이름을 수정 했습니다.");
		}else {
			System.out.println(std5+"학생의 이름을 수정하지 못했습니다.");
		}
		
		/* 삭제 */
		std4.setSt_grade(2); //2학년 1반 11번으로 바꿈
