...
public class Ex16_List {
	...
	public static void main(String[] args) {
		...
		list.remove((Integer)20); //Integer를 붙여서 값이 20인 놈을 삭제함.
		System.out.println(list);
		 ...
		 * - o1과 o2가 같은 클래스이면 o1.equal를 이용하여 비교 //같은 주소인지
		 * */
		System.out.println(list2);
		list2.remove(new Point(1, 1));
		System.out.println(list2);
		list2.add(new Point(-1, -1));
		list2.add(new Point(-11, -11));
		System.out.println(list2);
		...
		//Objects.equals 이용하여 같은 객체를 찾아서 번지를 반환
		int index = list2.indexOf(new Point(-11, -11));
